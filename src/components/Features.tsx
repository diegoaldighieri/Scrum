...
import { Bell, ShoppingCart, TrendingUp, Copy, BarChart3 } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            ...
            <br />
            <span className="text-[#38D594]">del tuo portafoglio</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {features.map((feature, i) => (
            <div
              key={i}
              className="group p-8 bg-slate-900/50 backdrop-blur-sm border border-[#38D594]/10 hover:border-[#38D594]/30 rounded-xl transition-all duration-300"
            >
              <div className="w-14 h-14 bg-[#38D594]/10 rounded-xl flex items-center justify-center text-[#38D594] mb-6 group-hover:bg-[#38D594]/20 transition-colors">
                {feature.icon}
              </div>
              ...
              <div className="pt-4 border-t border-[#38D594]/10">
          ...
          {/* CTA Card */}
          <div className="p-8 bg-gradient-to-br from-[#38D594]/10 to-emerald-500/10 backdrop-blur-sm border border-[#38D594]/20 rounded-xl flex flex-col items-center justify-center text-center">
            ...
            <button className="px-6 py-3 bg-[#38D594] hover:bg-emerald-500 text-slate-950 font-semibold rounded-lg transition-all duration-300">
