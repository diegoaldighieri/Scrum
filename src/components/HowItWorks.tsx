          ...
          <div className="bg-slate-900/50 backdrop-blur-sm border border-primary/10 rounded-2xl p-8 md:p-12 hover:border-primary/20 transition-all">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <div className="aspect-square bg-linear-to-br from-slate-800 to-slate-900 rounded-xl overflow-hidden border border-primary/20 hover:border-primary/40 transition-all p-4">
                  <Image
